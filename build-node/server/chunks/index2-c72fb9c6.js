...
const object_ref = Object;
const array_ref = Array;
const is_array = array_ref.isArray;
const array_from = array_ref.from;
const define_property = object_ref.defineProperty;
const get_descriptor = object_ref.getOwnPropertyDescriptor;
const SOURCE = 1;
const DERIVED = 1 << 1;
const EFFECT = 1 << 2;
  ...
  signal.e(value, signal.v)) {
    ...
    if (current_effect === null && current_queued_pre_and_render_effects.length === 0) {
      ...
      if (update_callbacks != null) {
        update_callbacks.b.forEach(
          /** @param {any} c */
          (c) => c()
        );
        const managed = managed_effect(() => {
          destroy_signal(managed);
          update_callbacks.a.forEach(
            /** @param {any} c */
            (c) => c()
          );
        });
...
function store_get_dev(store_values, store_name, store) {
...
export { render_effect as a, pop$1 as b, current_component_context as c, define_property as d, array_from as e, destroy_signal as f, push as g, copy_payload as h, assign_payload as i, bind_props as j, pop as k, get_descriptor as l, is_array as m, safe_equal as n, get as o, push$1 as p, set as q, render as r, source as s, create_anchor as t, slot as u, escape as v, store_get_dev as w, unsubscribe_stores as x, get_or_init_context_map as y };
//# sourceMappingURL=index2-c72fb9c6.js.map
